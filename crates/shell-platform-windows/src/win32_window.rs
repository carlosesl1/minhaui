...
use windows::Win32::UI::WindowsAndMessaging::{
    ...
    SW_SHOWNOACTIVATE, SWP_NOACTIVATE, SWP_NOZORDER, SWP_SHOWWINDOW, SetWindowPos, ShowWindow,
    UnregisterClassW, WINDOW_EX_STYLE, WNDCLASSEXW, WS_EX_NOACTIVATE, WS_EX_TOOLWINDOW,
    WS_EX_TOPMOST, WS_POPUP,
};
use windows::core::{PCWSTR, Result, w};

use crate::win32::{DOCK_WINDOW, LIVE_WINDOWS};
...
impl OwnedWindow {
    pub(super) fn create(
        ...
        if role == ShowcaseRole::Dock {
            DOCK_WINDOW.store(hwnd.0 as isize, std::sync::atomic::Ordering::Release);
